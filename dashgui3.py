...
app.layout = html.Div([
    ...
    html.Div(id='output-graph',style={'border':'1px thin white',
     ...
     html.Div([html.Img(src="https://scontent.fktm7-1.fna.fbcdn.net/v/t1.15752-9/33248996_1815512585208179_4439205380270063616_n.png?_nc_cat=0&_nc_eui2=AeFUyiXtZ3tPE5snaZBGMXswweQm6Ir-cSkltTAcTD7smq0763x4zJccHvq6CXcGlPy_8zU4zb4i0eqE92iIMZTbwIHiUz8l_TySP1UH81SnrQ&oh=8bcb56d83a84e48d0926aa52c03b3535&oe=5B91C9AB",
                style={
                    'height': '50%',
                    'width': '50%',
                     'display': 'block',
	...
	if graph_plot=='All data':
		        ...
		        figure={
		            ...
		            'layout': {
			            ...
			            'xaxis' : dict(
			                ...
			                size=20,
			                color='#7f7f7f',
			                range=[min(df.index),max(df.index)],
			            )),
			            'yaxis' : dict(
	    ...
	    for ticker in enumerate(input_data):
	        ...
	        return html.Div([dcc.Graph(
	            ...
	            style={'margin':'0px 0px 60px 0px','border-bottom':'1px solid #F2F2F2'}
	        ),html.Div([
	        	...
	        	html.Div(children='A candlestick is a chart that displays the high, low, opening and closing prices of a security for a specific period. The wide part of the candlestick is called the "real body" and tells investors whether the closing price was higher or lower than the opening price. Black/red indicates that the stock closed lower and white/green indicates that the stock closed higher.',
	        		style={'font-family': 'Product Sans','font-size':'1.25em','margin':'20px','margin-left':'300px','padding':'10px auto 10px auto','color': colors['background']}),
	        ...
	        style={'display':'inline-block','color': colors['background'],'font-size': '1.25em','font-family': 'Product Sans','padding':'10','margin':'50','margin-top':'-10px'}
	           ...
	           html.H1("Don't know what candlestick chart is? This might help",
                style={
                       'textAlign': 'center',
                       'color': colors['text'],
                       'font-size': '2.12em',
	        ...
	        html.Img(src="http://2oqz471sa19h3vbwa53m33yj.wpengine.netdna-cdn.com/wp-content/uploads/2017/11/candlestick-charts.jpg",
                style={
                    'height': '100%',
                    'width': '100%',
                     'display': 'block',
...
app.css.append_css({"external_url": "https://codepen.io/SajanBasnet75/pen/YLbYNG.css"})
